...
import com.example.demo.service.exception.DuplicateNameException;
...
public class CustomerController {
    ...
    @GetMapping("")
    public String listCustomers(Model model, @PageableDefault(size = 10) Pageable pageable,
    ...
    @PostMapping("/create")
    public ModelAndView createCustomer(@Validated @ModelAttribute("customer") Customer customer, BindingResult bindingResult) throws DuplicateNameException {
    ...
    @PostMapping("/edit")
    public ModelAndView editCustomer(@ModelAttribute("customer") Customer customer) throws DuplicateNameException {
        customerService.save(customer);
